...
- 托盘菜单支持打开控制台、打开横条、打开简易控制页、复制浏览器源地址、复制控制台地址、修改端口、清空队列、打开数据文件夹、打开日志和退出
- 当天队列异常退出恢复
- 配置导入、导出与导入前自动备份
...
- 托盘右键菜单支持打开控制台、打开横条、复制浏览器源地址、清空队列、打开数据文件夹、打开日志文件和退出。
