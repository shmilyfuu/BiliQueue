/* Vendored from qrcode-terminal / Kazuhiko Arase QRCode, MIT license. */
(function(){
const modules={
...
const cache={};
function require(id){ if(cache[id]) return cache[id].exports; const fn=modules[id]; if(!fn) throw new Error('QR module not found: '+id); const module={exports:{}}; cache[id]=module; fn(module,module.exports,require); return module.exports; }
window.QRCodeModel=require('./index');
window.QRErrorCorrectLevel=require('./QRErrorCorrectLevel');
})();
